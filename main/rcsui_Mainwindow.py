...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.cursor_switch, 0, 5, 1, 1)
        self.Ampselect_comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.Ampselect_comboBox.setObjectName("Ampselect_comboBox")
        self.Ampselect_comboBox.addItem("")
        self.Ampselect_comboBox.addItem("")
        self.Ampselect_comboBox.addItem("")
        self.gridLayout_2.addWidget(self.Ampselect_comboBox, 0, 17, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.current_time, 0, 15, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.AmpUP, 0, 9, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.X_press, 0, 13, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ECheckBox, 0, 8, 1, 1)
        self.zoomswitch = QtWidgets.QCheckBox(self.centralwidget)
        self.zoomswitch.setObjectName("zoomswitch")
        self.gridLayout_2.addWidget(self.zoomswitch, 0, 4, 1, 1)
        ...
        self.drawnumber_combobox.addItem("")
        self.drawnumber_combobox.addItem("")
        self.gridLayout_2.addWidget(self.drawnumber_combobox, 0, 19, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.NCheckBox, 0, 7, 1, 1)
        ...
        self.Amp_display.setMinimumSize(QtCore.QSize(120, 0))
        self.Amp_display.setMaximumSize(QtCore.QSize(120, 16777215))
        ...
        self.gridLayout_2.addWidget(self.Amp_display, 0, 16, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ZCheckBox, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_stationdrawnumber, 0, 20, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.reset, 0, 12, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.Ampdown, 0, 11, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 0, 18, 1, 1)
        self.traveltime_checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.traveltime_checkBox.setObjectName("traveltime_checkBox")
        self.traveltime_checkBox.setChecked(True)
        self.gridLayout_2.addWidget(self.traveltime_checkBox, 0, 2, 1, 1)
        self.pick_phase_checkbox = QtWidgets.QCheckBox(self.centralwidget)
        self.pick_phase_checkbox.setObjectName("pick_phase_checkbox")
        self.pick_phase_checkbox.setChecked(True)
        self.gridLayout_2.addWidget(self.pick_phase_checkbox, 0, 1, 1, 1)
        ...
        self.qmlcanvas.setGeometry(QtCore.QRect(0, 0, 1241, 781))
        ...
        self.menufile.addAction(self.action_export_phase)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Ampselect_comboBox.setItemText(0, _translate("MainWindow", "μm/S"))
        self.Ampselect_comboBox.setItemText(1, _translate("MainWindow", "μm"))
        self.Ampselect_comboBox.setItemText(2, _translate("MainWindow", "μm/S²"))
        ...
        self.Amp_display.setText(_translate("MainWindow", "0"))
        ...
        self.traveltime_checkBox.setText(_translate("MainWindow", "理论到时"))
        self.pick_phase_checkbox.setText(_translate("MainWindow", "震相"))
