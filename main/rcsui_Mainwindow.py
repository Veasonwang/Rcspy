...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.timelength_combobox = QtWidgets.QComboBox(self.centralwidget)
        self.timelength_combobox.setMaximumSize(QtCore.QSize(60, 16777215))
        self.timelength_combobox.setObjectName("timelength_combobox")
        self.timelength_combobox.addItem("")
        self.timelength_combobox.addItem("")
        self.timelength_combobox.addItem("")
        self.timelength_combobox.addItem("")
        self.timelength_combobox.addItem("")
        self.timelength_combobox.addItem("")
        self.gridLayout_2.addWidget(self.timelength_combobox, 0, 18, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ECheckBox, 0, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.reset, 0, 9, 1, 1)
        self.globalChenckBox = QtWidgets.QCheckBox(self.centralwidget)
        self.globalChenckBox.setObjectName("globalChenckBox")
        self.gridLayout_2.addWidget(self.globalChenckBox, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.Ampdown, 0, 8, 1, 1)
        ...
        self.name_label.setMinimumSize(QtCore.QSize(100, 20))
        self.name_label.setMaximumSize(QtCore.QSize(100, 16777215))
        ...
        self.gridLayout_2.addWidget(self.name_label, 0, 12, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.NCheckBox, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.cursor_switch, 0, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.AmpUP, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.X_stretch, 0, 11, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.X_press, 0, 10, 1, 1)
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setObjectName("label")
        self.gridLayout_2.addWidget(self.label, 0, 17, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.timelength_combobox.setItemText(0, _translate("MainWindow", "Atuo"))
        self.timelength_combobox.setItemText(1, _translate("MainWindow", "60"))
        self.timelength_combobox.setItemText(2, _translate("MainWindow", "240"))
        self.timelength_combobox.setItemText(3, _translate("MainWindow", "960"))
        self.timelength_combobox.setItemText(4, _translate("MainWindow", "1800"))
        self.timelength_combobox.setItemText(5, _translate("MainWindow", "3600"))
        self.ECheckBox.setText(_translate("MainWindow", "E"))
        self.reset.setText(_translate("MainWindow", "Reset"))
        self.globalChenckBox.setText(_translate("MainWindow", "全局拖动"))
        ...
        self.label.setText(_translate("MainWindow", "显示时长"))
