...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NCheckBox.stateChanged['int'].connect(MainWindow._changeStationVisibility)
        self.ECheckBox.stateChanged['int'].connect(MainWindow._changeStationVisibility)
