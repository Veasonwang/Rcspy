...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ZButton.setGeometry(QtCore.QRect(0, 10, 51, 23))
        self.ZButton.setObjectName("ZButton")
        self.NButton = QtWidgets.QPushButton(self.tools1)
        self.NButton.setGeometry(QtCore.QRect(60, 10, 51, 23))
        self.NButton.setObjectName("NButton")
        self.EButton = QtWidgets.QPushButton(self.tools1)
        self.EButton.setGeometry(QtCore.QRect(120, 10, 51, 23))
        self.EButton.setObjectName("EButton")
        self.AButton = QtWidgets.QPushButton(self.tools1)
        self.AButton.setGeometry(QtCore.QRect(180, 10, 51, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AButton.setText(_translate("MainWindow", "ALL"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.tools1), _translate("MainWindow", " "))
        self.toolBox.setItemText(self.toolBox.indexOf(self.toos2), _translate("MainWindow", " "))
